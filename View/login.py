...
def register_user():
    ...
    file = open("Controller/" + username_info, "w")
...
def login_verify():
    ...
    list_of_files = os.listdir("Controller/")
    if username1 in list_of_files:
        file1 = open("Controller/" + username1, "r")
...
def login_sucess():
    ...
    Label(login_success_screen, text="Login Successful! Welcome to Kakuro!").pack()
...
def main_account_screen():
    ...
    Label(text="Kakuro - Information Sys", bg="green", width="300", height="2", font=("Calibri", 13)).pack()
    Label(text="").pack()
